...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/03/24 20:50:20 by tcynthia          #+#    #+#             */
/*   Updated: 2022/03/25 01:45:34 by tcynthia         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
std::ostream&	operator<< ( std::ostream& os, const Form& data )
{
	...
	os << "execRequiered Grade = " << data.getExecRequiredGrade() << " and signedState = " << data.getFormSignedState() ;
	return (os);
}
